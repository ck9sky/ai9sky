...
class DALLE_API_PY_Test1(generic.FormView):
    ...
    def get_context_data(self, **kwargs):
        """ WHY do I use plus_context dic? I read online about how to "add more" context to a Django template, and/or
        update context vars on-the-fly such that I am able to send back the image_url generated by OpenAI module--maybe
        could try to use ajax (?), but plus_context works.
